        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground mb-8"><span className="text-primary text-2xl">Buy</span> what you want & <span className="text-primary text-2xl">Sell</span> what you don't.
                <br/>
